...
#tfidf
import pickle
with open('final_tfidf11_creative_id_age.pkl', 'rb') as f:
    f1 = pickle.load(f)    
with open('final__tfidf11_ad_id_age.pkl', 'rb') as f:
    f2 = pickle.load(f)
with open('final__tfidf11_advertiser_id_age.pkl', 'rb') as f:    
    f3 = pickle.load(f)
...
np.save("age_model/wuzhe_submission_nn_age3_1input_fc256_drop0.4_bn0.4_datatime_relr_{}.npy".format(np.mean(score1)), oof)
...
np.save("age_model/wuzhe_submission_nn_age3_1input_fc256_drop0.4_bn0.4_datatime_relr_dastr_{}.npy".format(np.mean(score2)), oof1)