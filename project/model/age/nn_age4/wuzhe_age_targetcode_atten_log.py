...
filepath = "age_model/nn_v2_lstm_tarcode_5id_atten1_0.h5" 
...
filepath = "age_model/nn_v2_lstm_tarcode_5id_atten1_1.h5" 
model_age.load_weights(filepath)
...
filepath = "age_model/nn_v2_lstm_tarcode_5id_atten1_2.h5" 
model_age.load_weights(filepath)
...
filepath = "age_model/nn_v2_lstm_tarcode_5id_atten1_3.h5" 
model_age.load_weights(filepath)
...
filepath = "age_model/nn_v2_lstm_tarcode_5id_atten1_4.h5" 
model_age.load_weights(filepath)
...
#submit.to_csv("age_model/submission_nn_age3_wuzhe_256wei_targetcode_atten_5id_{}.csv".format(np.mean(score)),index=False)
...
np.save("/model/stacking /wuzhe_submission_nn_age3_wuzhe_targetcode_atten_5id_relr_{}.npy".format(np.mean(score1)), oof)
...
np.save("/model/stacking /wuzhe_submission_nn_age3_wuzhe_targetcode_atten_5id_relr_dastr_{}.npy".format(np.mean(score2)), oof1)
