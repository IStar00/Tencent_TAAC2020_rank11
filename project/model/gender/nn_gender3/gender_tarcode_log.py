...
with open('tfidf/final_count11_creative_id_gender.pkl', 'rb') as f:    
    f6 = pickle.load(f)
with open('gender_model/final_target_ad_id_9_gender.pkl', 'rb') as f:    
    f7 = pickle.load(f)    
...
gc.collect()
model_age = model_conv(emb1, emb3,emb6,emb7, num_feature_input)############
...
def dataloader(test_index):
    ...
    gc.collect()
    return x1_va, x3_va,x6_va, x5_va,x11_va, x33_va,x66_va,y_va  ,x7_va,x77_va
...
filepath = "gender_model/nn_v1_gender_tarcode_0.h5" 
model_age.load_weights(filepath)
x1_va, x3_va,x6_va, x5_va,x11_va, x33_va,x66_va ,y_va ,x7_va,x77_va =dataloader(num0_test)

oof_pred[num0_test] = model_age.predict([x1_va, x3_va,x6_va,x7_va, x5_va],batch_size=1024,verbose=1)###2048 
sub += model_age.predict([test_input_1, test_input_3,test_input_6,test_input_7,test_input_5],batch_size=1024,verbose=1)/skf.n_splits##   
oof_pred_da[num0_test] = model_age.predict([x11_va, x33_va,x66_va,x77_va, x5_va],batch_size=1024,verbose=1)
sub_da += model_age.predict([test_input_11, test_input_33,test_input_66,test_input_77,test_input_5],batch_size=1024,verbose=1)/skf.n_splits
    
filepath = "gender_model/nn_v1_gender_tarcode_1.h5" 
model_age.load_weights(filepath)
x1_va, x3_va,x6_va, x5_va,x11_va, x33_va,x66_va ,y_va ,x7_va,x77_va=dataloader(num1_test)

oof_pred[num1_test] = model_age.predict([x1_va, x3_va,x6_va,x7_va, x5_va],batch_size=1024,verbose=1)###2048
sub += model_age.predict([test_input_1, test_input_3,test_input_6,test_input_7,test_input_5],batch_size=1024,verbose=1)/skf.n_splits##
oof_pred_da[num1_test] = model_age.predict([x11_va, x33_va,x66_va,x77_va, x5_va],batch_size=1024,verbose=1)
sub_da += model_age.predict([test_input_11, test_input_33,test_input_66,test_input_77,test_input_5],batch_size=1024,verbose=1)/skf.n_splits
###########################


filepath = "gender_model/nn_v1_gender_tarcode_2.h5" 
model_age.load_weights(filepath)
x1_va, x3_va,x6_va, x5_va,x11_va, x33_va,x66_va ,y_va ,x7_va,x77_va=dataloader(num2_test)

oof_pred[num2_test] = model_age.predict([x1_va, x3_va,x6_va,x7_va, x5_va],batch_size=1024,verbose=1)###2048
sub += model_age.predict([test_input_1, test_input_3,test_input_6,test_input_7,test_input_5],batch_size=1024,verbose=1)/skf.n_splits##
oof_pred_da[num2_test] = model_age.predict([x11_va, x33_va,x66_va,x77_va, x5_va],batch_size=1024,verbose=1)
sub_da += model_age.predict([test_input_11, test_input_33,test_input_66,test_input_77,test_input_5],batch_size=1024,verbose=1)/skf.n_splits
 ###########################   
    
filepath = "gender_model/nn_v1_gender_tarcode_3.h5" 
model_age.load_weights(filepath)
x1_va, x3_va,x6_va, x5_va,x11_va, x33_va,x66_va ,y_va ,x7_va,x77_va=dataloader(num3_test)

oof_pred[num3_test] = model_age.predict([x1_va, x3_va,x6_va,x7_va, x5_va],batch_size=1024,verbose=1)###2048
sub += model_age.predict([test_input_1, test_input_3,test_input_6,test_input_7,test_input_5],batch_size=1024,verbose=1)/skf.n_splits##
oof_pred_da[num3_test] = model_age.predict([x11_va, x33_va,x66_va,x77_va, x5_va],batch_size=1024,verbose=1)
sub_da += model_age.predict([test_input_11, test_input_33,test_input_66,test_input_77,test_input_5],batch_size=1024,verbose=1)/skf.n_splits
###########################

filepath = "gender_model/nn_v1_gender_tarcode_4.h5" 
model_age.load_weights(filepath)
x1_va, x3_va,x6_va, x5_va,x11_va, x33_va,x66_va ,y_va ,x7_va,x77_va=dataloader(num4_test)

oof_pred[num4_test] = model_age.predict([x1_va, x3_va,x6_va,x7_va, x5_va],batch_size=1024,verbose=1)###2048
sub += model_age.predict([test_input_1, test_input_3,test_input_6,test_input_7,test_input_5],batch_size=1024,verbose=1)/skf.n_splits##
oof_pred_da[num4_test] = model_age.predict([x11_va, x33_va,x66_va,x77_va, x5_va],batch_size=1024,verbose=1)
sub_da += model_age.predict([test_input_11, test_input_33,test_input_66,test_input_77,test_input_5],batch_size=1024,verbose=1)/skf.n_splits
...
np.save("gender_model/wuzhe_submission_nn_gender3_atten_targetcode_datatime_relr_{}.npy".format(np.mean(score1)), oof)
​
#五折
...
np.save("gender_model/wuzhe_submission_nn_gender3_atten_targetcode_datatime_relr_dastr_{}.npy".format(np.mean(score2)), oof1)
​
