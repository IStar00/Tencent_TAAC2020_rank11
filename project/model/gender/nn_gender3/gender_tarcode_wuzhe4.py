...
#    os.mkdir("model")
count = 4  ###########################10!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! ###########################10!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!                                                                    
train_index=num4_train ###########################10!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
test_index=num4_test ###########################10!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!


print("FOLD | ", count+1)
print("###"*35)
gc.collect()
filepath = "gender_model/nn_v1_gender_tarcode_%d.h5" % count
...
del  train_input_11,train_input_33,train_input_66,train_input_5,label,train_input_77
gc.collect()
...
hist = model_age.fit(  [da_x1_tr, da_x3_tr,da_x6_tr,da_x7_tr, da_x5_tr],     #
                         da_y_tr, batch_size=1024, epochs=50,  #4096
                          validation_data=([da_x1_va, da_x3_va, da_x6_va,da_x7_va,da_x5_va], da_y_va), #  validation_data=([x1_va, x5_va], y_va),
