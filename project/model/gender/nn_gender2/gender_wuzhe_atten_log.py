...
emb7=np.load('256_w2c/naw2v_128_product_id_xuli95_win15iter8_emb.npy')
...
with open('tfidf/final_count11__ad_id_gender.pkl', 'rb') as f:
    f4 = pickle.load(f)    
with open('tfidf/final_count11_advertiser_id_gender.pkl', 'rb') as f:
    f5 = pickle.load(f)
with open('tfidf/final_count11_creative_id_gender.pkl', 'rb') as f:    
    f6 = pickle.load(f)
...
skf = StratifiedKFold(n_splits=5, random_state=1015, shuffle=True)
...
def model_conv(emb1, emb3, emb6,emb7,num_feature_input,len_id_input): #emb3,  , num_feature_input
    ...
    x = Dropout(0.4)(Activation(activation="relu")(BatchNormalization()(Dense(1200)(x))))
...
filepath = "gender_model/nn_v1_gender_atten0.h5" 
...
filepath = "gender_model/nn_v1_gender_atten1.h5" 
model_age.load_weights(filepath)
...
filepath = "gender_model/nn_v1_gender_atten2.h5" 
model_age.load_weights(filepath)
...
filepath = "gender_model/nn_v1_gender_atten3.h5" 
model_age.load_weights(filepath)
...
filepath = "gender_model/nn_v1_gender_atten4.h5" 
model_age.load_weights(filepath)
...
np.save("gender_model/wuzhe_submission_nn_gender3_atten_relr_{}.npy".format(np.mean(score1)), oof)
...
np.save("gender_model/wuzhe_submission_nn_gender4_atten_relr_dastr_{}.npy".format(np.mean(score2)), oof1)